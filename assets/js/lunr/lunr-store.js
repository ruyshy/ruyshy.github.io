var store = [{
        ...
        "excerpt":"C++의 조건문과 반복문이 디스어셈블리에서 어떻게 구현되는지 궁금하신가요? 이 포스트에서는 Visual Studio 디버거를 활용해 if문, for문을 실제 실행파일 수준에서 분석하고, cmp, jmp, jge, add 등의 핵심 명령어 패턴을 정확히 짚어드립니다. 1. Visual Studio 설정 (이전이랑 동일) 빌드 모드: Release 플랫폼: x64 최적화: 끄기 (/Od) 그리고 C++ 코드 작성 후, 디버깅 시작해서...","categories": ["reversing_engineering"],
        "tags": ["assembly","disassembly","VisualStudio","조건문 어셈블리","루프 구조","cmp","jmp","x64 디버깅"],
        "url": "/reversing_engineering/reversing1-disassembly2/",
        "teaser": null
      }]
