...
### 어떻게 해야 생산성을 높일 수 있을지..

앞으로 어떻게 하면 더 편하게 쓸 수 있을까 여러 고민이 듭니다.. 

바로 몇 가지 방법이 생각이 들긴 하는데.. 정보를 더 모은 후, 생각 정리 후에야 방향성이 정해질 것 같습니다.

1. Notion 에서 GitHub를 연동하는 방법
2. Notion 에서 내보내기 .md 파일을 Python으로 변환하기
3. Visual Studio Code Extesion 만들어서 사용하기
4. … 이대로 Notion 에서 내보내기 사용하기