---
layout: single
title:  "OpenGL: Triangle Indices"
permalink: /OpenGL/Triangle-Indices
categories: OpenGL
typora-root-url: ../
...
int main()
{
	...
	GLfloat vertices[] =
	{
		...
		0.0f, 0.5f * float(sqrt(3)) * 2 / 3, 0.0f, // 위 중앙
		-0.5f / 2, 0.5f * float(sqrt(3)) / 6, 0.0f, // 안쪽 왼쪽
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindVertexArray(VAO);
		//프리미티브 그리기, 인덱스 수, 인덱스 데이터 유형, 인덱스 인덱스
